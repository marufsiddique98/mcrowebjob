                                                ...
                                                <div class="tk-verified-info">
                                                    <strong>
                                                        ...
                                                        <?php if($gig->gigAuthor->user->userAccountSetting->verification == 'approved'): ?>
                                                            <i data-tippy-content="<?php echo e(__('general.verified_user')); ?>" class="tippy fa-solid fa-circle-check"></i> 
                                                        <?php endif; ?>
                                                    </strong>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script defer src="<?php echo e(asset('js/vendor/venobox.min.js')); ?>"></script>
    <script>
        window.onload = (event) => {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', ['title' =>$gig->title, 'include_menu' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sharif/Desktop/Laravel Project/mcrowebjob/resources/views/front-end/gig/gig-detail.blade.php ENDPATH**/ ?>