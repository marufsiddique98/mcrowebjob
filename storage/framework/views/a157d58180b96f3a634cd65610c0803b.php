                                    ...
                                    <?php $__currentLoopData = $available_payment_methods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="tk-paymentoption">
                                            <div class="tk-form-checkbox">
                                                <input class="form-check-input tk-form-check-input-sm selected_payment_method" name="payment_method" wire:model.defer="payment_method"  type="radio" id="radio-<?php echo e($key); ?>" <?php echo e($payment_method == 'key' ? 'checked' : ''); ?>    value="<?php echo e($key); ?>"   />
            ...
            stripe.confirmCardPayment(event.detail.clientSecret)
                .then(function(result) {
                    if (result.error) {
                        ...
                        window.livewire.find('<?php echo e($_instance->id); ?>').processSecureCheckout(event.detail.transaction_id);
                    }
                });
        });
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/sharif/Desktop/Laravel Project/mcrowebjob/resources/views/livewire/components/checkout.blade.php ENDPATH**/ ?>