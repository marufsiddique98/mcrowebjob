    ...
    <main class="tk-scetiondb">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class=" <?php if( ( $method_type == 'escrow' && $user_role == 'buyer' ) || $user_role == 'seller'): ?> col-lg-8 <?php else: ?> col-12 <?php endif; ?> gy-4">
                    <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'seller')): ?>
                        <?php
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('7fxUm8C')) {
    $componentId = $_instance->getRenderedChildComponentId('7fxUm8C');
    $componentTag = $_instance->getRenderedChildComponentTagName('7fxUm8C');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('7fxUm8C');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('7fxUm8C', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php else: ?>
...
} elseif ($_instance->childHasBeenRendered('hOtGYK9')) {
    $componentId = $_instance->getRenderedChildComponentId('hOtGYK9');
    $componentTag = $_instance->getRenderedChildComponentTagName('hOtGYK9');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('hOtGYK9');
} else {
    $response = \Livewire\Livewire::mount('earnings.invoices', ['className' => 'tk-dbinvoice']);
    $html = $response->html();
    $_instance->logRenderedChild('hOtGYK9', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php endif; ?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('XH2lCkk')) {
    $componentId = $_instance->getRenderedChildComponentId('XH2lCkk');
    $componentTag = $_instance->getRenderedChildComponentTagName('XH2lCkk');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('XH2lCkk');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('XH2lCkk', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
<script>
    window.onload = (event) => {
        jQuery(document).ready(function() {
            ...
            let labels      = "<?php echo e(!empty($date_intervals) ? implode(',', $date_intervals): ''); ?>";
            let price_range = "<?php echo e(!empty($price_intervals) ? implode(',', $price_intervals): ''); ?>";
...
<?php echo $__env->make('layouts.app',['include_menu' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sharif/Desktop/Laravel Project/mcrowebjob/resources/views/front-end/dashboard/dashboard.blade.php ENDPATH**/ ?>