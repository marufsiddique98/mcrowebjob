        ...
        <div class="tk-project-wrapper tk-gigstep_2">
            <div class="tk-project-box tk-project-boxvtwo">
                ...
                <div class="tk-attachments-hodler" id="gig-plans">
                    <?php if(count($gig_plans) < 3): ?>
                        <a class="tk-add-more mb-2" href="javascript:;" wire:click.prevent="addNewPlan"><h6><?php echo e(__('gig.add_new')); ?> </h6><i class="icon-plus"></i></a>
                    <?php endif; ?>
                            ...
                            <div class="tk-attechment-tittle">
                                ...
                                <div class="tk-accord-rightside">
                                    <div class="tk-switchbtn">
                                        <label for="is-featured-<?php echo e($key); ?>" wire:key="is-featured-<?php echo e($key); ?>-<?php echo e(time()); ?>" class="tk-textdes"><span id="tk-textdes"><?php echo e(__('gig.featured')); ?></span></label>
                                ...
                                <form class="tk-themeform">
                                    <fieldset>
                                        <div class="tk-themeform__wrap">
                                            ...
                                            <?php if( count($gig_plans) > 1 ): ?>
                                                <div class="form-group">
                                                    <a class="tk-Remove-adon" href="javascript:;" wire:click.prevent="removePlan(<?php echo e($key); ?>)"><i class="icon-trash-2"></i><span><?php echo e(__('gig.remove_plan')); ?></span></a>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                    </fieldset>
...
<?php /**PATH /home/sharif/Desktop/Laravel Project/mcrowebjob/resources/views/livewire/gig/gig-step2.blade.php ENDPATH**/ ?>