				...
				<div class="tk-uploadprofilepic">
					...
					<div wire:ignore class="tk-freelancer-content-two">
						...
						<div class="tk-uploadbtnpic">
							...
							<a href="javascript:void(0);" wire:click.prevent="removePhoto" class="tk-btn tk-btnsmall tk-btnlight"><?php echo e(__('settings.remove')); ?></a>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="tk-freelancer-content-two">
							...
							<div class="tk-uploadbtnpic">
								...
								<?php if( ( !empty($banner) && method_exists($banner,'temporaryUrl') ) || !empty($old_banner) ): ?>
									<a href="javascript:void(0);" wire:click.prevent="removeBanner" class="tk-btn tk-btnsmall tk-btnlight"><?php echo e(__('settings.remove')); ?></a>
								<?php endif; ?>
							</div>
						</div>
					</div>
...
</div><?php /**PATH /home/sharif/Desktop/Laravel Project/mcrowebjob/resources/views/livewire/profile-settings/profile-settings.blade.php ENDPATH**/ ?>