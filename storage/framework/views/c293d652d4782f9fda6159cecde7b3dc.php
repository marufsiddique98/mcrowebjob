                                                ...
                                                <?php if(!empty($existingFiles)): ?>
                                                    <?php $__currentLoopData = $existingFiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="tb-uploadel tb-upload-two">
                                                            ...
                                                            <span><?php echo e($file->getClientOriginalName()); ?> <a href="javascript:void(0);" wire:click.prevent="removeFile('<?php echo e($key); ?>')"> <i class="icon-trash-2"></i></a> </span>
                                                        </div>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php endif; ?>
                                            </div>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/sharif/Desktop/Laravel Project/mcrowebjob/resources/views/livewire/admin/disputes/dispute-detail.blade.php ENDPATH**/ ?>