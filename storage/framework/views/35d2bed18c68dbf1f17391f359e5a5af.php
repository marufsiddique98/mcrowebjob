...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('bsHHvCD')) {
    $componentId = $_instance->getRenderedChildComponentId('bsHHvCD');
    $componentTag = $_instance->getRenderedChildComponentTagName('bsHHvCD');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('bsHHvCD');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('bsHHvCD', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        </aside>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sharif/Desktop/Laravel Project/mcrowebjob/resources/views/front-end/gig/gig-cart.blade.php ENDPATH**/ ?>