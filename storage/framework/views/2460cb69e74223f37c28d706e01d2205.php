                                        ...
                                        <ul class="tb-uploadbar">
                                            ...
                                            <?php if(!empty($package['image']) && method_exists($package['image'],'temporaryUrl')): ?>
                                                <div wire:loading.remove class="tb-uploadel tb-upload-two">
                                                    ...
                                                    <span><?php echo e($package['image']->getClientOriginalName()); ?> <a href="javascript:void(0);" wire:click.prevent="removeImage"> <i class="icon-trash-2"></i></a> </span>
                                                </div>
                                            <?php elseif(!empty($old_image)): ?>
                                                ...
                                                <div wire:loading.remove class="tb-uploadel tb-upload-two">
                                                    ...
                                                    <span><?php echo e($image_name); ?><a href="javascript:void(0);" wire:click.prevent="removeImage"> <i class="icon-trash-2"></i></a></span>
                                                </div>
                                            <?php endif; ?>
                                        </ul>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/sharif/Desktop/Laravel Project/mcrowebjob/resources/views/livewire/admin/packages/packages.blade.php ENDPATH**/ ?>