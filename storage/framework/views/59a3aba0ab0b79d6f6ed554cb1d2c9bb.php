                                ...
                                <tr>  
                                    ...
                                    <td data-label="<?php echo e(__('general.actions')); ?>">
                                        <ul class="tb-action-icon">
                                            ...
                                            <li> <a href="javascript:;" onClick="confirmation(<?php echo e($single->id); ?>)" class="tb-delete"><i class="icon-trash-2"></i></a> </li> 
                                        </ul>
                                    </td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/sharif/Desktop/Laravel Project/mcrowebjob/resources/views/livewire/admin/email-templates/email-templates.blade.php ENDPATH**/ ?>