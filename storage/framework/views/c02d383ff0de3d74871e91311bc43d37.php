<div class="col-lg-8 col-xl-9" wire:key="identity-verification">
	<div class="tb-dhb-profile-settings">
        ...
        <?php endif; ?>   
        <?php if( $isVerifiedAcc == 'processed' && 1==2): ?>
	    ...
	    <?php elseif( $isVerifiedAcc == 'approved' && 1==2 ): ?>
...
</div><?php /**PATH /home/sharif/Desktop/Laravel Project/mcrowebjob/resources/views/livewire/profile-settings/identity-verification.blade.php ENDPATH**/ ?>