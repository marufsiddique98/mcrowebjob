...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('cEgomNd')) {
    $componentId = $_instance->getRenderedChildComponentId('cEgomNd');
    $componentTag = $_instance->getRenderedChildComponentTagName('cEgomNd');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('cEgomNd');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('cEgomNd', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('Bvu4kLA')) {
    $componentId = $_instance->getRenderedChildComponentId('Bvu4kLA');
    $componentTag = $_instance->getRenderedChildComponentTagName('Bvu4kLA');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Bvu4kLA');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('Bvu4kLA', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script defer src="<?php echo e(asset('js/vendor/splide.min.js')); ?>"></script>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/sharif/Desktop/Laravel Project/mcrowebjob/resources/views/livewire/project/project-activity.blade.php ENDPATH**/ ?>