 ...
 <div class="tk-feedback-section-wrpper">
     ...
     <div class="tk-feedback-slider-container">
         <div class="tk-feedback-slide">
             <?php if(!empty(pagesetting('feedback'))): ?>
                 <?php $__currentLoopData = pagesetting('feedback'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="tk-feedback-item" <?php if(!empty($option['feedback_image'][0]['path'])): ?> style="background-image: url(<?php echo e(asset('storage/'.$option['feedback_image'][0]['path'])); ?>);" <?php endif; ?>>
                        <div class="tk-feedback-slider-content">
                            <div class="tk-feedback-slider-description">
                                ...
                                <p><?php echo $option['paragraph'] ?? ''; ?></p>
                            </div>
                            <div class="tk-feedback-slider-ratting">
                            <span class="tk-stars"><span></span></span>
                                <h3><?php echo e($option['name'] ?? ''); ?></h3>
                                <span><?php echo e($option['role'] ?? ''); ?> <strong>@ <?php echo e($option['company'] ?? ''); ?></strong></span>
                            </div>
                        </div>
                    </div>
...
<?php if (! $__env->hasRenderedOnce('d983995d-6211-4dac-8d4f-6c41a3e0236f')): $__env->markAsRenderedOnce('d983995d-6211-4dac-8d4f-6c41a3e0236f');
...
<?php $__env->stopPush(); endif; ?>
   <?php /**PATH /home/sharif/Desktop/Laravel Project/mcrowebjob/resources/views/pagebuilder/client-feedback/view.blade.php ENDPATH**/ ?>