                                ...
                                <ul class="tb-uploadbar">
                                    ...
                                    <?php if(!empty($image) && method_exists($image,'temporaryUrl')): ?>
                                        <div  wire:loading.remove class="tb-uploadel tb-upload-two">
                                            ...
                                            <span><p><?php echo e($image->getClientOriginalName()); ?></p> <a href="javascript:void(0);" wire:click.prevent="removeImage"> <i class="icon-trash-2"></i></a> </span>
                                        </div>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/sharif/Desktop/Laravel Project/mcrowebjob/resources/views/livewire/admin/taxonomies/project-categories/update.blade.php ENDPATH**/ ?>