...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('PR7yRwf')) {
    $componentId = $_instance->getRenderedChildComponentId('PR7yRwf');
    $componentTag = $_instance->getRenderedChildComponentTagName('PR7yRwf');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('PR7yRwf');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('PR7yRwf', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?> 
		</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', ['include_menu' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sharif/Desktop/Laravel Project/mcrowebjob/resources/views/front-end/gig/gig-gridview.blade.php ENDPATH**/ ?>