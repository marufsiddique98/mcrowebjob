...
<?php endif; ?>
                                    ...
                                    <input type="hidden" name="updateItems" id="updateItems" wire:key="updated-items-<?php echo e($menu_id); ?>">
                                    <input type="hidden" name="removalIds" id="removalIds" wire:key="removed-items-<?php echo e($menu_id); ?>">
                                </form>
                            </div>
                            <div class="tb-selectmenu">
                                <div class="tb-checkbox">
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            setTimeout(function() {
                ...
                $(document).on('change', "#menu_id", function(e) {
                    window.livewire.find('<?php echo e($_instance->id); ?>').set('menu_id', $(this).select2('val'));
                })
...
<?php $__env->stopPush(); ?><?php /**PATH /home/sharif/Desktop/Laravel Project/mcrowebjob/resources/views/livewire/admin/menu/manage-menu.blade.php ENDPATH**/ ?>