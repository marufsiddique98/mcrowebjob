...
<div class="tk-loginconatiner">
    <div class="tk-login-content">
        <div class="tk-login-info">
            ...
            <?php endif; ?>
            <?php if( !empty($description) ): ?><span><?php echo e($description); ?></span><?php endif; ?>
        </div>
        <?php echo e($slot); ?>

    </div>
    <div class="tk-login-banner">
        <?php if( !empty($auth_bg) ): ?>
            <figure class="tk-login-img">
                <img src="<?php echo e(asset('storage/'.$auth_bg)); ?>" alt="login image">
            </figure>
        <?php endif; ?>
    </div>
</div><?php /**PATH /home/sharif/Desktop/Laravel Project/mcrowebjob/resources/views/components/auth-card.blade.php ENDPATH**/ ?>