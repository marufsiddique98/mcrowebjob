...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('84vzAM6')) {
    $componentId = $_instance->getRenderedChildComponentId('84vzAM6');
    $componentTag = $_instance->getRenderedChildComponentTagName('84vzAM6');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('84vzAM6');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('84vzAM6', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('OIATuvt')) {
    $componentId = $_instance->getRenderedChildComponentId('OIATuvt');
    $componentTag = $_instance->getRenderedChildComponentTagName('OIATuvt');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('OIATuvt');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('OIATuvt', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                <?php endif; ?>            
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sharif/Desktop/Laravel Project/mcrowebjob/resources/views/front-end/gig/gig-activity.blade.php ENDPATH**/ ?>