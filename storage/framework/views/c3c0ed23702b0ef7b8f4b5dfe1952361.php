                        ...
                        <tbody>
                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $single): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <td data-label="<?php echo e(__('general.status')); ?>" onClick="deleteUser(<?php echo e($single->id); ?>, '<?php echo e($single->status); ?>')">
...
<script>
    ...
    function deleteUser( id, status ){
        ...
        let content         = status == 'activated' ? '<?php echo e(__("general.deactivate_user_acc")); ?>' : '<?php echo e(__("general.activate_user_acc")); ?>';
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/sharif/Desktop/Laravel Project/mcrowebjob/resources/views/livewire/admin/users/users.blade.php ENDPATH**/ ?>