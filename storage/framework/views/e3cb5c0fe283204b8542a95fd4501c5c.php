...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('jB1JWFv')) {
    $componentId = $_instance->getRenderedChildComponentId('jB1JWFv');
    $componentTag = $_instance->getRenderedChildComponentTagName('jB1JWFv');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('jB1JWFv');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('jB1JWFv', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?> 
                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', ['include_menu' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sharif/Desktop/Laravel Project/mcrowebjob/resources/views/front-end/gig/gig-listview.blade.php ENDPATH**/ ?>