...
<?php foreach($attributes->onlyProps(['gig', 'currency_symbol','is_save_item', 'user_role', 'address_format' => 'city_state_country']) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
<?php $attributes = $attributes->exceptProps(['gig', 'currency_symbol','is_save_item', 'user_role', 'address_format' => 'city_state_country']); ?>
<?php foreach (array_filter((['gig', 'currency_symbol','is_save_item', 'user_role', 'address_format' => 'city_state_country']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<?php endif; ?> 
                ...
                <ul class="tk-rateviews tk-rateviews2">
                    ...
                    <?php if($user_role == 'buyer' || Auth::guest()): ?>
                        <li>
                            <span class="tk-save-btn tk-fav-item <?php echo e($gig?->is_favourite || $is_save_item ? 'tk-favourite' : ''); ?>" wire:click.prevent="saveItem(<?php echo e($gig->id); ?>)">
                                <i class="icon-heart"></i> 
                                <em><?php echo e($gig?->is_favourite || $is_save_item ? __('general.saved') : __('general.save')); ?></em>
                            </span>
                        </li>
                    <?php endif; ?>
...
</li><?php /**PATH /home/sharif/Desktop/Laravel Project/mcrowebjob/resources/views/components/gig-item.blade.php ENDPATH**/ ?>