...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('CXyQ7q8')) {
    $componentId = $_instance->getRenderedChildComponentId('CXyQ7q8');
    $componentTag = $_instance->getRenderedChildComponentTagName('CXyQ7q8');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('CXyQ7q8');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('CXyQ7q8', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
<?php echo $__env->make('layouts.app',['include_menu' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sharif/Desktop/Laravel Project/mcrowebjob/resources/views/front-end/sellers/search-sellers.blade.php ENDPATH**/ ?>