    ...
    <?php if(!empty($page_loaded)): ?>
        <?php if( !empty($gigs) && $gigs->count() > 0 ): ?>
            <?php $__currentLoopData = $gigs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gig): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div id="gig_<?php echo e($gig->id); ?>" class="col-sm-12 col-md-6 col-lg-4">
                    <div class="tk-topservicetask">
                        <figure class="tk-card__img">
                            ...
                            <?php if($roleName == 'buyer' || Auth::guest()): ?>
                                <div class="tk-like <?php echo e($gig->is_favourite ? 'tk-heartsave' : ''); ?>">
                                    <a href="javascript:void(0);" class="tb_saved_items <?php echo e($gig->is_favourite ? 'tk-heartsave' : ''); ?>" wire:click.prevent="saveItem(<?php echo e($gig->id); ?>)">
...
<?php endif; ?> 
                                ...
                                <div class="tk-featureRating">
                                    ...
                                    <?php else: ?>
                                        <address>
                                            <i class="icon-map-pin"></i><?php echo e($gig->country); ?>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/sharif/Desktop/Laravel Project/mcrowebjob/resources/views/livewire/gig/gig-gridview.blade.php ENDPATH**/ ?>