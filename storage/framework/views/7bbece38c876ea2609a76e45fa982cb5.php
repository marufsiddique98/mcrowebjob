...
<?php foreach($attributes->onlyProps(['profile', 'currency_symbol', 'is_save_item', 'user_role', 'address_format' => 'state_country']) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
<?php $attributes = $attributes->exceptProps(['profile', 'currency_symbol', 'is_save_item', 'user_role', 'address_format' => 'state_country']); ?>
<?php foreach (array_filter((['profile', 'currency_symbol', 'is_save_item', 'user_role', 'address_format' => 'state_country']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<?php endif; ?> 
                        ...
                        <ul class="tk-blogviewdatessm">
                            ...
                            <?php if($user_role == 'buyer' || Auth::guest()): ?>
                                <li class="tk-saved <?php echo e(!empty($profile->is_favourite) || $is_save_item ? 'tk-liked' : ''); ?> mt-0" wire:click.prevent="saveItem(<?php echo e($profile->id); ?>)">
                ...
                <div class="tk-price-two">
                    ...
                    <h4><?php echo e(__('general.per_hour_rate', ['rate' => number_format($profile->hourly_rate, 2), 'currency_symbol' => $currency_symbol])); ?></h4>
            ...
            <div class="tk-tags-holder">
                <?php if(!empty($profile->description)): ?>
                    <?php 
                        ...
                        $short_desc = add3DotsInText($desc, ' ...', 300);
                    ?>
...
</div><?php /**PATH /home/sharif/Desktop/Laravel Project/mcrowebjob/resources/views/components/seller-item.blade.php ENDPATH**/ ?>