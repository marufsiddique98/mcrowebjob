                            ...
                            <div class="tk-project-box">
                                <div class="tk-verified-title">
                                    ...
                                    <div class="tk-projectinfo_description"> 
                                        <?php if(!empty($project->projectAuthor->tagline)): ?><p><strong><?php echo e($project->projectAuthor->tagline); ?><strong></p><?php endif; ?>
                                    </div>
                                    <div class="tk-projectinfo_description">
                                        <?php if(!empty($project->projectAuthor->description)): ?><p><?php echo e($project->projectAuthor->description); ?></p><?php endif; ?>
                                    </div>
                                </div>
                                <ul class="tk-checkout-info">
                                    ...
                                    <li>
                                        <a href=<?php echo e(route('search-projects', ['author_id' => $project->author_id])); ?> class="tk-btn"> 
                                            <span><?php echo e(__('project.see_all_posted_projects')); ?></span><i class="icon-arrow-right"></i>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                                    ...
                                    <div class="tk-project-box">
                                        <div class="tk-verified-info">
                                            <div class="tk-verified-info_title">
                                                <span><?php echo e(\Carbon\Carbon::parse($single->updated_at)->format('M d, Y')); ?></span>
                                                <h5><a href="<?php echo e(route('project-detail', ['slug'=> $single->slug] )); ?>"><?php echo e($single->project_title); ?></a></h5>
                                            </div>
                                            <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'seller')): ?>  
                                                <a href="javascript:void(0)" wire:key="<?php echo e($single->id); ?>" wire:click.prevent="saveProject(<?php echo e($single->id); ?>)" class="<?php echo e($single->is_favourite ? 'tk-btnline tk-liked tk-saved' : 'tk-btnline tk-save'); ?> tk-btn-like-<?php echo e($single->id); ?>"> 
                                                    <i class="icon-heart"></i>
                                                </a>
                                            <?php endif; ?>
                                        </div>
                                        <div class="tk-project-price">
                                            ...
                                            <h6><?php echo e($single->project_type == 'fixed' ?  __('project.fixed_project_budget') : __('project.hourly_project_budget')); ?></h6>
                                        ...
                                        <div class="tk-description">
                                            <p><?php echo e(__('project.project_paragraph')); ?></p>
                                        </div>
                                        <ul class="tk-projectinfo-list">
                                            <li class="tk-info-location"><i class="icon-map-pin"></i> <?php echo e($single->projectLocation->id == 3 ? (!empty($single->address) ? getUserAddress($single->address, $address_format) : $single->project_country ) : $single->projectLocation->name); ?></li>
                                            <?php if(!empty($single->expertiseLevel)): ?><li class="tk-info-expertise"><i class="icon-briefcase"></i><?php echo e($single->expertiseLevel->name); ?></li><?php endif; ?>
                                            <li class="tk-info-freelancer"><i class="icon-users"></i> <?php echo e($single->project_hiring_seller .' '. ($single->project_hiring_seller > 1 ? __('project.freelancers') : __('project.freelancer'))); ?></li>
                                        </ul>
                                        <?php if(!empty($single->skills)): ?>
                                            <ul class="tk-language-tags" id="skills-<?php echo e($single->id); ?>">
                                                <?php
                                                    $remainingSkillsCount = $single->skills->count() - 3;
                                                ?>
                    
                                                <?php $__currentLoopData = $single->skills->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li>
                                                ...
                                                <?php if($remainingSkillsCount > 0): ?>
                                                    <li class="more-skills">
                                                        <a href="javascript:void(0)" class="tk-anchor-tag" 
                                                            onclick="showMoreSkills(<?php echo e($single->id); ?>, 'projects')"
                                                            data-toggle="tooltip" 
                                                            title="<?php echo e(implode(', ', $single->skills->slice(3)->pluck('name')->toArray())); ?>">
                                                ...
                                                <?php $__currentLoopData = $single->skills->slice(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="tk-projects-footer">
                                            ...
                                            <a href="<?php echo e(route('project-detail', ['slug'=> $single->slug] )); ?>" class="tk-btnline"><?php echo e(__('project.view_project')); ?></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/sharif/Desktop/Laravel Project/mcrowebjob/resources/views/livewire/project/project-detail.blade.php ENDPATH**/ ?>