                                                            ...
                                                            <?php if( !in_array($proposal->status, ['publish','pending', 'declined','draft']) ): ?>
                                                                <li>
                                                                    <div class="tk-hire-freelancer_content">
                                                                        <img src="<?php echo e($user_image); ?>" alt="<?php echo e($proposal->proposalAuthor->short_name); ?>">
                                                                        <div class="tk-hire-freelancer-info">
                                                                            <h6>
                                                                                <?php echo e($proposal->proposalAuthor->short_name); ?>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/sharif/Desktop/Laravel Project/mcrowebjob/resources/views/livewire/project/buyer-projects.blade.php ENDPATH**/ ?>