        ...
        <div class="tb-printable">
            ...
            <table class="tb-table tb-invoice-table">
                <thead>
                    <tr>
                        <th> #</th>
                        <th class="tb-invoicetitle"><?php echo e(__('project.inv_title')); ?></th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td data-label="<?php echo e(__('project.inv_title')); ?>" class="tb-invoicetitle"><?php echo e($invoice_title); ?></td>
                        <?php if($transaction_type == 3): ?>
...
<?php /**PATH /home/sharif/Desktop/Laravel Project/mcrowebjob/resources/views/livewire/earnings/export-invoice.blade.php ENDPATH**/ ?>