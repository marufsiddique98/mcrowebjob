    ...
    <section class="tk-searchproject-section tk-main-bg">
        <div class="container">
            <div class="row">
                ...
                <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('project.search-projects', ['priceRange' => $price_range,'categoryId' => $category_id,'projectMinPrice' => $project_min_price,'projectMaxPrice' => $project_max_price,'price_range' => $price_range,'keyword' => $keyword,'category_id' => $category_id,'project_min_price' => $project_min_price,'project_max_price' => $project_max_price,'authorId' => $authorId])->html();
} elseif ($_instance->childHasBeenRendered('StFozSH')) {
    $componentId = $_instance->getRenderedChildComponentId('StFozSH');
    $componentTag = $_instance->getRenderedChildComponentTagName('StFozSH');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('StFozSH');
} else {
    $response = \Livewire\Livewire::mount('project.search-projects', ['priceRange' => $price_range,'categoryId' => $category_id,'projectMinPrice' => $project_min_price,'projectMaxPrice' => $project_max_price,'price_range' => $price_range,'keyword' => $keyword,'category_id' => $category_id,'project_min_price' => $project_min_price,'project_max_price' => $project_max_price,'authorId' => $authorId]);
    $html = $response->html();
    $_instance->logRenderedChild('StFozSH', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
        ...
        window.onload = (event) => {
            ...
            jQuery(document).ready(function() {
                ...
                $(document).on('click', '#clearFilters', function(event) {
                    ...
                    if (isAuthorFilter) {
                        window.location.href = '<?php echo e(route("search-projects")); ?>';
                    }
                });
...
<?php echo $__env->make('layouts.app',['include_menu' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sharif/Desktop/Laravel Project/mcrowebjob/resources/views/front-end/projects/search-projects.blade.php ENDPATH**/ ?>